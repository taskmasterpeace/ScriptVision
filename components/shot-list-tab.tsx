    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>Manage your shot list for production</CardDescription>
        </div>
        <Button onClick={handleGenerateShotList} disabled={isLoading("generateShotList") || !script}>
      ...
      <CardContent>
        {showSuccess && shotList.length > 0 && (
          <Alert className="mb-4 bg-green-50 border-green-200">
            ...
            <AlertDescription>{shotList.length} shots have been generated from your script.</AlertDescription>
          </Alert>
        )}
        ...
        {shotList.length > 0 ? (
          ...
          <div className="text-center py-12 border rounded-md bg-muted/10">
            ...
            {script ? (
              <Button variant="outline" onClick={handleGenerateShotList} disabled={isLoading("generateShotList")}>
                {isLoading("generateShotList") ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Generating...
