  ...
  const journeySteps: JourneyStep[] = [
    {
      ...
      phase: "creation",
      isCompleted: () => Boolean(scriptCreationState.storyTheme && scriptCreationState.storyTheme.length > 0),
    ...
    },
    {
      ...
      icon: <FileText className="h-5 w-5" />,
      phase: "production",
      isCompleted: () => Boolean(projectState.script && projectState.script.length > 0),
      tabValue: "script",
    },
    {
      id: "shotlist",
    ...
    <div className="mb-6 bg-card border rounded-lg p-6 shadow-md">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Track your progress through the story creation process</p>
        </div>
        <div className="flex items-center gap-4 mt-2 md:mt-0">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-purple-500"></div>
            <span className="text-sm font-medium">Creation</span>
            <span className="text-sm font-bold">{completionPercentage.creation}%</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-amber-500"></div>
            <span className="text-sm font-medium">Production</span>
            <span className="text-sm font-bold">{completionPercentage.production}%</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative">
            ...
            <div className="border rounded-lg p-4 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20">
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-base font-semibold text-purple-800 dark:text-purple-300">Script Creation</h4>
          ...
          <div className="relative">
            ...
            <div className="border rounded-lg p-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-base font-semibold text-amber-800 dark:text-amber-300">Production</h4>
