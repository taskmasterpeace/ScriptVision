...
const defaultModels: AIModel[] = [
  {
    ...
    capabilities: ["Text generation", "Creative writing", "Complex reasoning", "Detailed analysis"],
  ...
  },
  {
    ...
    name: "GPT-4 Turbo",
    provider: "OpenAI",
    description: "A powerful model with a good balance of capabilities and cost.",
  ...
  persist(
    (set, get) => ({
      ...
      getModelForPhase: (phase: ApplicationPhase) => {
        return get().phaseModelMapping[phase] || defaultPhaseModelMapping[phase]
      },
